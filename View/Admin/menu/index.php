   ...
   <section class="content">
      ...
      <div class="box box-info">
         <div class="box-header with-border">
            <button class="btn btn-info btn-sm" id="test2" onclick="openwindow('增加菜单','{#WN_URL('admin','menu',['type'=>'add'])}',2)">增加菜单</button>
         </div>
            ...
            <table class="table table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="text-center">
                        <button class="btn btn-info btn-sm" onclick="openwindow('编辑','{#WN_URL('admin','menu',['type'=>'edit','id'=>$v['id']])}',2)">修改</button>
