      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php foreach ($sidebar as $v): ?>
          <?php if (empty($v['chile'])): ?>
            <li class=" <?php if (METHOD_NAME == ucfirst($v['name2'])): ?>active<?php endif ?>"><a href="<?php echo WN_URL('admin',$v['name2']);?>"><i class="block <?php echo $v['icon'];?>"></i> <span><?php echo $v['name'];?></span></a></li>
          <?php else: ?>
            <li class="treeview <?php if (METHOD_NAME == ucfirst($v['name2'])): ?>active<?php endif ?>">
              <a href="#">
              ...
              <ul class="treeview-menu">
                ...
                <li class="<?php if (METHOD_NAME == ucfirst($v['name2']) && X('type') == $val['name2']): ?>active<?php endif ?>"><a href="<?php echo WN_URL('admin', $v['name2'],['type'=> $val['name2']]);?>"><i class="fa fa-circle-o"></i> <?php echo $val['name'];?></a></li>
                <?php endforeach ?>
              </ul>
            </li>
          <?php endif ?>
        ...
        <li class="header">帮助链接</li>
        <li><a href="<?php echo WWW;?>"><i class="block fa fa-desktop"></i> <span>网站首页</span></a></li>
        <li><a href="#"><i class="fa fa-book text-red"></i> <span>开发文档</span></a></li>
        <li><a href="#"><i class="fa fa-comments text-yellow"></i> <span>官方论坛</span></a></li>
        <li><a href="#"><i class="fa fa-qq text-aqua"></i> <span>QQ 群</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
   ...
   <section class="content">
      ...
      <div class="box box-info">
         <div class="box-header with-border">
            <button class="btn btn-info btn-sm" id="test2" onclick="openwindow('标题','<?php echo WN_URL('admin','jiekou',['type'=>'admin_group']);?>',2)">增加分组</button>
         </div>
