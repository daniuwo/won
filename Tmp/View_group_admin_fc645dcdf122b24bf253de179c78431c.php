        ...
        <?php foreach ($sidebar as $v): ?>
          ...
          <?php else: ?>
            <?php if (empty($v['chile'])): ?>
              <li class=" <?php if (is_active($v['name2'])): ?>active<?php endif ?>"><a href="<?php echo WN_URL($v['name2']);?>"><i class="block <?php echo $v['icon'];?>"></i> <span><?php echo $v['name'];?></span></a></li>
            <?php else: ?>
         ...
         <div class="box-body table-responsive no-padding no-border">
            <table class="table table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                     <td class="text-center"><?php echo $v['role_id'];?></td>
                     <td><span style="color:<?php echo $v['color'];?>"><?php echo $v['name'];?></span></td>
                     <td class="text-center"><span style="color:<?php echo $v['color'];?>"><?php echo $v['color'];?></span></td>
                     ...
                     <td class="text-center">
                        <button class="btn btn-info btn-sm" onclick="openwindow('编辑','<?php echo WN_URL('admin','jiekou',['type'=>'admin_group_edit','role_id'=>$v['role_id']]);?>',2)">修改</button>
