   ...
   <section class="content">
      ...
      <div class="box box-info">
         <div class="box-header with-border">
            <button class="btn btn-info btn-sm" id="test2" onclick="openwindow('新建组','<?php echo WN_URL('admin','admin_group',['type'=>'add']);?>',2)">增加分组</button>
         </div>
            ...
            <table class="table table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="text-center">
                        <button class="btn btn-info btn-sm" onclick="openwindow('编辑组','<?php echo WN_URL('admin','admin_group',['type'=>'edit','role_id'=>$v['role_id']]);?>',2)">修改</button>
