        ...
        <form class="form-horizontal" action="" method="POST" id="form">
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="smtp" class="form-control" id="inputEmail3" placeholder="" value="<?php if (isset($config_email['smtp'])): ?><?php echo $config_email['smtp'];?><?php endif ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputtext3" class="col-sm-2 control-label">端口</label>
                    <div class="col-sm-5">
                        <input type="text" name="port" class="form-control" id="inputtext3" placeholder="" value="<?php if (isset($config_email['port'])): ?><?php echo $config_email['port'];?><?php endif ?>">
                    </div>
                    <div class="col-sm-5">
                        <select name="secure" class="form-control">
                           <option value="" <?php if (isset($config_email['secure'])&& empty($config_email['secure'])): ?>selected<?php endif ?>>不加密 </option> 
                           <option value="ssl" <?php if (isset($config_email['secure'])&&$config_email['secure']=='ssl' ): ?>selected<?php endif ?>>SSL加密 </option> 
                           <option value="tls" <?php if (isset($config_email['secure'])&&$config_email['secure']=='tls' ): ?>selected<?php endif ?>>TLS加密 </option> 
                        </select> 
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="user" class="form-control" id="inputtext3" placeholder="" value="<?php if (isset($config_email['user'])): ?><?php echo $config_email['user'];?><?php endif ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputtext3" class="col-sm-2 control-label">密码</label>
                    <div class="col-sm-10">
                        <input type="password" name="pass" class="form-control" id="inputtext3" placeholder="" value="<?php if (isset($config_email['pass'])): ?><?php echo $config_email['pass'];?><?php endif ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputtext3" class="col-sm-2 control-label">发信帐号</label>
                    <div class="col-sm-10">
                        <input type="text" name="sendemail" class="form-control" id="inputtext3" placeholder="" value="<?php if (isset($config_email['sendemail'])): ?><?php echo $config_email['sendemail'];?><?php endif ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputtext3" class="col-sm-2 control-label">测试发送</label>
                    <div class="col-sm-5">
                        <input type="text" name="testemail" class="form-control" id="inputtext3" value="<?php if (isset($config_email['testemail'])): ?><?php echo $config_email['testemail'];?><?php endif ?>" placeholder="输入收信邮箱">
  ...
  <div class="control-sidebar-bg"></div>
   ...
   <script>
      $('#testsend').click(function() {
         ...
         $.ajax({
            type: "post",
            url: "<?php echo WN_URL('admin','testemail');?>",
            data: dataform,
            dataType: "json",
            success: function(e) {
               if (e.error) {
