            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-md-6">
                        <input type="text" name="wwwname" class="form-control" id="inputEmail3" placeholder="" value="<?php echo $config_www['wwwname'];?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputtext3" class="col-sm-2 control-label">网站域名</label>
                    <div class="col-sm-4 col-md-6">
                        <input type="text" name="domain" class="form-control" id="inputtext3" placeholder="" value="<?php echo $config_www['domain'];?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputtext3" class="col-sm-2 control-label">网站关键词(Keywords)</label>
                    <div class="col-sm-4 col-md-6">
                        <input type="text" name="keywords" class="form-control" id="inputtext3" placeholder="" value="<?php echo $config_www['keywords'];?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputtext3" class="col-sm-2 control-label">网站描述(Description)</label>
                    <div class="col-sm-4 col-md-6">
                        <input type="text" name="description" class="form-control" id="inputtext3" placeholder="" value="<?php echo $config_www['description'];?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputtext3" class="col-sm-2 control-label">站长邮箱</label>
                    <div class="col-sm-4 col-md-6">
                        <input type="email" name="email" class="form-control" id="inputtext3" placeholder="" value="<?php echo $config_www['email'];?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputtext3" class="col-sm-2 control-label">站长QQ</label>
                    <div class="col-sm-4 col-md-6">
                        <input type="number" name="qq" class="form-control" id="inputtext3" placeholder="" value="<?php echo $config_www['qq'];?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-md-6">
                        <select name="weihu" class="form-control">
                            <option value="0" <?php if ($config_www['weihu'] == 0): ?>selected<?php endif ?>>开启网站</option>
                            <option value="1" <?php if ($config_www['weihu'] == 1): ?>selected<?php endif ?>>关闭网站</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-md-6">
                        <textarea name="weihu_msg" id="" cols="30" rows="3" class="form-control" placeholder="输入关站说明,显示到前台"><?php echo $config_www['weihu_msg'];?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputtext3" class="col-sm-2 control-label">统计代码</label>
                    <div class="col-sm-4 col-md-6">
                        <textarea name="tongji" id="" cols="30" rows="6" class="form-control" placeholder="第三方统计代码可以输入到这里"><?php echo $config_www['tongji'];?></textarea>
                    </div>
                </div>
            </div>
            <!-- /.box-body -->
