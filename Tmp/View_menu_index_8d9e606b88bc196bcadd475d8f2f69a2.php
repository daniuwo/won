   ...
   <section class="content">
      ...
      <div class="box box-info">
         <div class="box-header with-border">
            <button class="btn btn-info btn-sm" id="test2" onclick="openwindow('增加菜单','<?php echo WN_URL('admin','menu',['type'=>'add']);?>',2)">增加菜单</button>
         </div>
            ...
            <table class="table table-striped">
               <thead>
                  <tr>
                     ...
                     <th style="width: 100px;text-align: center">菜单</th>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="text-center">
                        <?php if ($v['menutype'] == 1): ?>
                           <span class="text-success">页面</span>
                           <?php elseif ($v['menutype'] == 2): ?>
                           <span class="text-success">链接</span>
                        <?php elseif ($v['menutype'] == 3): ?>
