...
<div class="content openwindow">
    <form id="form" class="form-horizontal form-ajax" role="form" data-toggle="validator" method="POST" action="">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <select class="form-control selectpicker" data-rule="required" name="fid">
                    ...
                    <?php foreach ($fuji as $k=> $v): ?>
                    <option value="<?php echo $v['id'];?>" <?php if ($v['_selected']): ?>selected<?php endif ?>> <?php echo $v['_name'];?></option>
                    <?php endforeach ?>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <select class="form-control selectpicker" data-rule="required" name="menutype">
                    <option value="1" <?php if ($data['menutype'] == 1): ?>selected<?php endif ?>> 系统页面</option>
                    <option value="2" <?php if ($data['menutype'] == 2): ?>selected<?php endif ?>> URL链接</option>
                    <option value="3" <?php if ($data['menutype'] == 3): ?>selected<?php endif ?>> 文字</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <div class="radio">
                    <label for="row[ismenu]-normal"><input id="row[ismenu]-normal" <?php if ($data['ismenu'] == 1): ?>checked="checked"<?php endif ?> name="ismenu" type="radio" value="1" > 是的</label> 
                    <label for="row[ismenu]-hidden"><input id="row[ismenu]-hidden" <?php if ($data['ismenu'] == 0): ?>checked="checked"<?php endif ?> name="ismenu" type="radio" value="0"> 不是</label>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <input type="text" class="form-control" id="name" name="name" value="<?php echo $data['name'];?>" data-rule="required" />
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-xs-12 col-sm-2">昵称:</label>
            <div class="col-xs-12 col-sm-8">
                <input type="text" class="form-control" id="name" name="name2" value="<?php echo $data['name2'];?>" data-rule="required" />
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-xs-12 col-sm-2">图标:</label>
            <div class="col-xs-12 col-sm-8">
                <input type="text" class="form-control" id="name" name="icon" value="<?php echo $data['icon'];?>" data-rule="required" />
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-xs-12 col-sm-2">关键词:</label>
            <div class="col-xs-12 col-sm-8">
                <input type="text" class="form-control" id="name" name="keydowds" value="<?php echo $data['keywords'];?>" data-rule="required" />
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <input type="text" class="form-control" id="name" name="paixu" value="<?php echo $data['paixu'];?>" data-rule="required" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <div class="radio">
                    <label for="row[status]-normal"><input id="row[status]-normal" <?php if ($data['status'] == 1): ?>checked="checked"<?php endif ?> name="status" type="radio" value="1" > 正常</label> 
                    <label for="row[status]-hidden"><input id="row[status]-hidden" <?php if ($data['status'] == 0): ?>checked="checked"<?php endif ?>  name="status" type="radio" value="0"> 隐藏</label>
                </div>
            </div>
        </div>
